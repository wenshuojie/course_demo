...
<body>
	...
	<div class="line">&nbsp;</div>
	<div id="foot">
	    <form action="altercourse_" method="post">
	        <div class="input-group input-group-lg" style="margin-left: 31%;">
	            ...
	            <input type="text" class="form-control" id="courseid" name="courseid" disabled="disabled" value='<%=courseid%>'/>
	        </div>
	        <br/>
	        <div class="input-group input-group-lg" style="margin-left: 31%;">
	            <span class="input-group-addon" style="width: 100px;!importent">课程名</span>
	            <input type="text" class="form-control" id="coursename" name="coursename" disabled="disabled" value='<%=coursename%>'/>
	        </div>
	        <br/>
	        <div class="input-group input-group-lg" style="margin-left: 31%;">
