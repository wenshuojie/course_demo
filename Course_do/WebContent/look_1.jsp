...
<body>
	<%
		...
		String sql1 = "select distinct 实验项目编号,名称, 班级编号 from course_do where 任课教师编号  = '"+userid+"'";
	...
	%>
   	...
   	%>
   				 <tr>
			         ...
			         <td><a href='look_1.1.jsp?experimentid=<%=rs.getString("实验项目编号") %>&experimentname=<%=rs.getString("名称") %>&classid=<%=rs.getString("班级编号") %>'>查看详情</a></th>  							         
			    </tr>
   	<%	
